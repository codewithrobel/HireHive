...
const Login = () => {
    ...
    return (
        <div className="flex items-center justify-center min-h-[calc(100vh-4rem)] px-4 relative overflow-hidden text-zinc-700 dark:text-zinc-300">
            ...
            <div className="max-w-md w-full bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg shadow-sm p-8 dark:border-zinc-200 relative z-10 mt-10 mb-10">
                {isOtpStep ? (
                    <>
                    ...
                    <>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                            ...
                            <button
                                type="submit"
                                className="w-full hover:bg-blue-600 hover:text-white transition-colors border border-blue-200 bg-blue-50 text-blue-600 dark:bg-blue-600/20 dark:text-blue-100  dark:bg-blue-600/20  dark:border-blue-200 dark:border-blue-800 text-blue-600 dark:text-blue-100 font-bold py-3.5 rounded-lg transition-all shadow-sm hover:shadow-md dark:hover:shadow-sm mt-8"
                            >
