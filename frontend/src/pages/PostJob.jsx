                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div className="flex items-center space-x-4">
                                ...
                                <label className="flex-1 cursor-pointer">
                                    <div className="w-full px-4 py-3.5 rounded-xl border border-white/10 hover:border-indigo-500/50 bg-black/20 hover:bg-black/40 text-zinc-400 transition-all font-medium shadow-inner text-center">
                                        Select Image...
                                    </div>
                                    <input
                                        type="file"
                        ...
                        <div>
                            ...
                            <select
                                className="w-full px-4 py-3.5 rounded-xl border border-white/10 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500/50 bg-black/20 focus:bg-black/40 text-white transition-all font-medium shadow-inner appearance-none relative"
                                {...register('type')}
                            >
                    ...
                    <div>
                        ...
                        <textarea
                            rows="6"
                            className="w-full px-4 py-3.5 rounded-xl border border-white/10 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500/50 bg-black/20 focus:bg-black/40 text-white placeholder-zinc-500 transition-all font-medium shadow-inner resize-y"
                    ...
                    <div className="flex justify-end pt-6 space-x-4 border-t border-white/10 mt-8">
                        ...
                        <button type="submit" className="relative group overflow-hidden px-8 py-3 rounded-xl font-bold transition-all border border-indigo-500/50 shadow-[0_0_15px_rgba(99,102,241,0.3)] hover:shadow-[0_0_25px_rgba(99,102,241,0.5)] bg-indigo-600/20">
                            ...
                            <span className="relative z-10 text-indigo-100 group-hover:text-white drop-shadow-md transition-colors">Post Job</span>
                        </button>
                    </div>
                </form>
            </div>
