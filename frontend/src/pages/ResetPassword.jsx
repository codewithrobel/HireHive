                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    <div>
                        ...
                        <input
                            type="text"
                            maxLength={6}
                            className="w-full px-4 py-3.5 text-center text-lg tracking-widest rounded-xl border border-zinc-300 dark:border-white/10 focus:border-indigo-400/80 dark:focus:border-indigo-500/50 bg-zinc-50 dark:bg-black/20 focus:outline-none focus:ring-2 text-zinc-900 dark:text-white transition-all font-bold shadow-inner"
                            placeholder="------"
                            value={otp}
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full px-4 py-3.5 pr-12 rounded-xl border border-zinc-300 dark:border-white/10 focus:border-indigo-400/80 dark:focus:border-indigo-500/50 bg-zinc-50 dark:bg-black/20 focus:outline-none focus:ring-2 text-zinc-900 dark:text-white transition-all font-medium shadow-inner"
                                placeholder="••••••••"
                                value={password}
                    ...
                    <div>
                        ...
                        <input
                            type="password"
                            className="w-full px-4 py-3.5 rounded-xl border border-zinc-300 dark:border-white/10 focus:border-indigo-400/80 dark:focus:border-indigo-500/50 bg-zinc-50 dark:bg-black/20 focus:outline-none focus:ring-2 text-zinc-900 dark:text-white transition-all font-medium shadow-inner"
                            placeholder="••••••••"
                    ...
                    <button
                        ...
                        className="w-full relative group overflow-hidden bg-indigo-600 text-white font-bold py-3.5 rounded-xl transition-all shadow-lg shadow-indigo-500/20 hover:scale-[1.02] active:scale-95 flex items-center justify-center gap-2 mt-2"
                    >
