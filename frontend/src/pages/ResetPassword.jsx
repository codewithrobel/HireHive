        ...
        <div className="flex items-center justify-center min-h-[calc(100vh-4rem)] px-4 relative overflow-hidden text-zinc-700 dark:text-zinc-300">
            ...
            <div className="max-w-md w-full bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg shadow-sm p-8 dark:border-zinc-200 relative z-10">
                <div className="text-center mb-8">
                    ...
                    {timer > 0 && (
                        <p className="text-blue-600 dark:text-blue-400 mt-2 text-sm font-black tracking-widest bg-blue-50 dark:bg-blue-100 dark:bg-blue-900/40 px-4 py-1.5 rounded-full inline-block">
                            EXPIRING IN: {timer}s
                        </p>
                    )}
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    <div>
                        ...
                        <input
                            type="text"
                            maxLength={6}
                            className="w-full px-4 py-3.5 text-center text-lg tracking-widest rounded-lg border border-zinc-300 dark:border-zinc-200 dark:border-zinc-800 focus:border-blue-400/80 dark:focus:border-blue-200 dark:border-blue-800 bg-zinc-50 dark:bg-zinc-800 focus:outline-none focus:ring-2 text-zinc-900 dark:text-white transition-all font-bold shadow-inner"
                            placeholder="------"
                            value={otp}
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full px-4 py-3.5 pr-12 rounded-lg border border-zinc-300 dark:border-zinc-200 dark:border-zinc-800 focus:border-blue-400/80 dark:focus:border-blue-200 dark:border-blue-800 bg-zinc-50 dark:bg-zinc-800 focus:outline-none focus:ring-2 text-zinc-900 dark:text-white transition-all font-medium shadow-inner"
                                placeholder="••••••••"
                                value={password}
                    ...
                    <div>
                        ...
                        <input
                            type="password"
                            className="w-full px-4 py-3.5 rounded-lg border border-zinc-300 dark:border-zinc-200 dark:border-zinc-800 focus:border-blue-400/80 dark:focus:border-blue-200 dark:border-blue-800 bg-zinc-50 dark:bg-zinc-800 focus:outline-none focus:ring-2 text-zinc-900 dark:text-white transition-all font-medium shadow-inner"
                            placeholder="••••••••"
                    ...
                    <button
                        ...
                        className="w-full hover:bg-blue-600 hover:text-white transition-colors border border-blue-600 bg-blue-50 text-blue-600 dark:bg-blue-600/20 dark:text-blue-100 bg-blue-600 text-white font-bold py-3.5 rounded-lg transition-all shadow-lg shadow-sm hover:scale-[1.02] active:scale-95 flex items-center justify-center gap-2 mt-2"
                    >
